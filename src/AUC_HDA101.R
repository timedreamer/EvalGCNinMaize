...
setwd("C:\\WORK\\Co-expression\\ChIPSeq\\HDA101\\correlationCoefficient")



hda101_vst_gcc <- read.delim("GRMZM2G172883_HDA101.rcclr",header=F,sep='\t')
hda101_vst_gcc[,2] <- abs(hda101_vst_gcc[,2])
