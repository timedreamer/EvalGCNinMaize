...
# in my 1266 libs, there are 16 experiments in total, 15 of them have more than 10 samples.
# provide each experiments sample names and caclculate PCC, MRNET and CLR.
library(parmigene)
library(edgeR)
